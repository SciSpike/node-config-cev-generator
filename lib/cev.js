...
var CASING_UNCHANGED = 'unchanged';
 ...
 * </code>
 * @param obj An object, most likely the one returned by <code>require('config')</code>
 ...
 *     (see exported DEFAULT_CASING, CASING_UPPER, CASING_LOWER, and CASING_UNCHANGED</li>
 ...
 * </ul>
 * @returns An object containing the generated environment variables for each key in the input object.
 */
